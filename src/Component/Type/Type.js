...
class Type extends React.Component {
	...
	clearText(callback) {
		clear_word = setInterval(
			function() {
				this.refs.com.innerHTML = this.refs.com.innerHTML.slice(
					0,
					this.refs.com.innerHTML.length - 1
				);
	...
	render() {
		return <span className={type_css.type_component} ref="com" />;
	}
}
